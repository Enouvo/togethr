        ...
        <div className="flex flex-col max-w-md">
          ...
          <div className="flex flex-col rounded-lg border-gray-500 border-2 p-8 mt-8 flex-wrap max-w-md">
            <p className="text-xl mb-0">
              <span className="font-bold mr-2">{latestProject?.tokenPrice}</span>
            ...
            <p className="text-gray-1000 text-base">
              ...
              respect for the diverse beliefs and values of all individuals and groups.The Arts Endowment encourages
              projects ...
            </p>
          </div>
