...
const ProjectDetailCarousel = ({ projects }) => {
        ...
        <div className="relative">
          ...
          >
            {carouselProjects?.map((project) => {
              return (
                <div>
                  <div className="flex xs:flex-col sm:flex-col md:flex-col lg:flex-col xl:flex-row justify-between xs:p-6 sm:p-12 md:p-24 px-48">
                    <img
          ...
          <div
            ...
            style={{ right: "29.125rem", bottom: "3.125rem" }}
          >
            <Button
