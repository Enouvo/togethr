      ...
      <div className="w-2/5 mt-4 mb-10 justify-center flex flex-col m-auto">
        <Form onFinish={onSubmit} layout="vertical">
          <div className="flex flex-col my-2">
            ...
            >
              <Input
                className="form-input bg-transparent font-extrabold"
          ...
          <div className="flex flex-col my-2">
            ...
            <Form.Item name="projectDescription">
              <Input.TextArea
                className="border-2 border-gray-300 rounded-lg py-2 px-3 focus:outline-none font-extrabold resize-none w-full text-gray-700 textarea-form"
